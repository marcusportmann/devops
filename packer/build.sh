...
function usage {
    ...
    echo "  -o OPERATING_SYSTEM  One of the following operating systems: centos-7, centos-8, rocky-8, ubuntu-2004, ubuntu-2204."
}
...
case "${option}" in
    ...
    p)
        ...
        ;;
    o)
        if [[ ${OPTARG} =~ ^centos-7|centos-8|rocky-8|ubuntu-2004|ubuntu-2204$ ]]
        then
